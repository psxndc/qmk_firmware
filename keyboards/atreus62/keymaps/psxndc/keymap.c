...
[_DEFAULT] = LAYOUT( 
  ...
  KC_LCTL, 			KC_LGUI, KC_LALT, MO(_WRD),MO(_WRD),MO(_LOWER), KC_SPC, KC_SPC, MO(_RAISE), MO(_WRD),  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT   \
),
 ...
 [_LOWER] = LAYOUT( \
  ...
  _______, _______, _______, _______, _______, _______,  _______, _______,  MO(_ADJUST), _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END  \
 ),
...
[_RAISE] = LAYOUT( \
  ...
  _______, _______, _______, _______, _______, MO(_ADJUST),  _______, _______, _______,  _______, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT  \
),
