...
LCTL_T(KC_BSPC), KC_A,   KC_R,    KC_S,    KC_T,    KC_G,                     KC_K,    KC_N,    KC_E,    KC_I,    KC_O,    RALT_T(KC_SCLN), \
  KC_LSFT,       KC_Z,   KC_X,    KC_C,    KC_D,    KC_V, MO(_WRD), KC_ESC,   KC_M,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT, \
                                  KC_LGUI, MO(_WRD),LOWER, KC_SPC,   KC_SPC,  RAISE,   KC_ENT, KC_RGUI \
),
...
[_LOWER] = LAYOUT( \
  ...
  KC_TILD, KC_LCBR, KC_LBRC, KC_LPRN, KC_MINS, KC_PLUS,                   KC_NLCK, KC_P4,   KC_P5,   KC_P6,   KC_PDOT, KC_PIPE, \
...
[_RAISE] = LAYOUT( \
  ...
  _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,   _______, _______, KC_CIRC, KC_AMPR, KC_ASTR, _______, KC_MUTE, KC_MPLY, \
                             _______, _______, _______,  _______, _______,  _______, _______, _______ \
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 */
 ...
 [_WRD] = LAYOUT( \
  ...
  _______, _______, _______, _______, _______, _______, _______, _______,  _______, KC_P1        , S(KC_DOWN), KC_P3        , _______, _______, \
							 _______, _______, _______, _______, _______,  _______, _______      , _______  \
 ),
