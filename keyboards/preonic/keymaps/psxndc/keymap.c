...
[_COLEMAK] = LAYOUT_preonic_grid( \
  ...
  KC_BSPC, KC_A,    KC_R,    KC_S,    KC_T,    KC_G,           KC_K,          KC_N,  KC_E,    KC_I,    KC_O,    KC_BSPC, \
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,           KC_M,          KC_H,  KC_COMM, KC_DOT,  KC_SLSH, KC_ENT,  \
  KC_LCTL, KC_LALT, KC_LGUI, KC_APP,  LOWER,   LSFT_T(KC_SPC), LSFT_T(KC_SPC),RAISE, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
),
...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  KC_CAPS, KC_F11,  KC_F12,  _______, _______, _______, KC_PSCR, KC_P7,   KC_P8,   KC_P9,   KC_P0,   KC_PIPE, \
  _______, KC_LCBR, KC_LBRC, KC_LPRN, KC_MINS, KC_PLUS, KC_NLCK, KC_P4,   KC_P5,   KC_P6,   KC_PDOT, KC_MUTE, \
  _______, KC_RCBR, KC_RBRC, KC_RPRN, KC_UNDS, KC_EQL,  _______, KC_P1,   KC_P2,   KC_P3,   KC_BSLS, KC_MPLY, \
...
[_ADJUST] = LAYOUT_preonic_grid( \
  ...
  _______, _______, _______, _______, _______, _______, _______, TERM_ON, TERM_OFF,_______, _______, DEBUG,    \
  _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  COLEMAK, _______,  _______, _______, \
  _______, MUV_DE,  MUV_IN,  MU_ON,   MU_OFF,  MI_ON,   MI_OFF,  _______, RGB_VAI, RGB_SAI, RGB_HUI, RGB_MOD , \
