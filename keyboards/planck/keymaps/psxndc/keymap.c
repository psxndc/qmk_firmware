...
[_LOWER] = LAYOUT_planck_grid(
   ...
   LCTL_T(KC_TILD), KC_LCBR, KC_LBRC, KC_LPRN, KC_MINS, KC_PLUS, KC_NLCK, KC_P4,   KC_P5,   KC_P6,   KC_PDOT, KC_PIPE, \
...
[_RAISE] = LAYOUT_planck_grid(
  ...
  LCTL_T(KC_MINS),KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_COLN, \
