...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_ortho(
        ...
        KC_DEL,	  KC_A,   		LALT_T(KC_R),LSFT_T(KC_S),LCTL_T(KC_T),KC_G,    KC_K,   	RCTL_T(KC_N),RSFT_T(KC_E),RALT_T(KC_I), KC_O,		 KC_SCLN,  KC_ENT,
        KC_LSFT,  KC_Z,    		KC_X, 		 KC_C,    	  KC_D,    	   KC_V,    KC_M,   	KC_H,  		 KC_COMM,	  KC_DOT,  		KC_SLSH, 	 KC_ENT,   KC_UP
        KC_LCTL,  KC_LGUI, 		KC_LALT, 	 WORD, 		  LOWER,   	   KC_SPC, 	KC_SPC,		RAISE,		 KC_RALT, 	  KC_RGUI, 		KC_CTRL,     KC_LEFT,  KC_DOWN, KC_RGHT 
	),
//LOWER
    [1] = LAYOUT_ortho(
        KC_CAPS, KC_F11,  KC_F12,  _______, _______, _______, KC_PSCR, KC_P7,   KC_P8,   KC_P9,   KC_P0,   _______,  KC_DEL, RGB_MOD,
...
/*,-----------------------------------------------------------------------------------------------------------------------.
 *|      |   1    |    2   |    3   |   4    |   5    |   6   |   7          |     8     |    9         |   0    |        |*/ 
  _______, _______, _______, _______, _______, _______,_______, KC_P7        , S(KC_UP)  , KC_P9        , _______, _______, _______,
