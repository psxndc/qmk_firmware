...
[1] = LAYOUT_65_ansi( /* FN */
    ...
    _______, _______, _______, _______, S1_DEC,  S1_INC,  S2_DEC,  S2_INC,  _______, _______, _______, RGB_MOD,          _______, RESET,\
    _______, EF_DEC,  EF_INC,  H1_DEC,  H1_INC,  H2_DEC,  H2_INC,  BR_DEC,  BR_INC,  ES_DEC,  ES_INC,  KC_MUTE,          KC_VOLU, KC_MPLY,\
