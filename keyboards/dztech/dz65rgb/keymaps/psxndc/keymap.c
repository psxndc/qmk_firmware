...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
		...
		[_COLEMAKDH] = LAYOUT_65_ansi( // colemak dh
		    ...
		    KC_LSFT,           KC_X,     KC_C,     KC_D,  KC_V,  KC_Z,  KC_M,    KC_H,  KC_COMM, KC_DOT,   KC_SLSH,  KC_RSFT,         KC_UP,     KC_DEL,\
		...
		*/		
		[_QWERTY] = LAYOUT_65_ansi( // QWERTY 
			KC_GESC,  KC_1,     KC_2,     KC_3,  KC_4,  KC_5,  KC_6,    KC_7,  KC_8,    KC_9,     KC_0,     KC_MINS,  KC_EQL,         KC_BSPC,  KC_HOME,\
		    KC_TAB,   KC_Q,     KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,     _______,  _______,  KC_BSLASH,KC_END,\
			KC_BSPC,    KC_A,     KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,  KC_QUOT,          KC_ENT,   KC_PSCR,\
		...
		[_FUNCTION] = LAYOUT_65_ansi( /* FN */
		    ...
		    TO(_QWERTY),        RGB_TOG,  RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI , _______, _______, _______, _______, KC_PSCR, KC_SLCK,  KC_PAUS, KC_KANA,KC_PGDN,\
			CTL_T(KC_CAPS),      RGB_SPI,  RGB_SPD, RGB_HUD,RGB_SAD, RGB_VAD, _______, _______, _______, _______, _______,  _______,         EEP_RST,  RESET,\
		    KC_LSFT,              _______,  _______, _______,_______, _______, _______, _______, _______, _______, _______,  KC_MPLY,        KC_VOLU,  KC_MUTE,\
